...
namespace WebCourseRepo
{
    public class Startup
    {
        ...
        {
            Console.WriteLine(Configuration.GetConnectionString("Connection avaible, DB Connected!"));
            services.AddDbContext<CourseContext>(opt => opt.UseSqlServer(Configuration.GetConnectionString("Connection avaible, DB Connected!")));
